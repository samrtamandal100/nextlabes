...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Stay Updated with the Latest from NextServeLabs
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
      Join our community to receive the latest insights, updates, and offers straight to your inbox. Be the first to know about new features, services, and industry trends that can help your business stay ahead.
      </p>
      <div>
        <input
          type="text"
